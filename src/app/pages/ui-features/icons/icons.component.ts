...
export class IconsComponent {
  ...
  constructor(iconsLibrary: NbIconLibraries) {
    ...
    // iconsLibrary.registerFontPack('fad', { packClass: 'fad', iconClassPrefix: 'fad' });
    // iconsLibrary.registerFontPack('fal', { packClass: 'fal', iconClassPrefix: 'fal' });
  ...
  icons = {
    ...
    fontAwesome: [
      ...
      'briefcase', 'bug', 'building', 'bullhorn', 'calculator'
    ],
